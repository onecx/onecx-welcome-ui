...
// @ts-ignore
import { ExportWelcomeRequest } from '../model/exportWelcomeRequest';
// @ts-ignore
import { ProblemDetailResponse } from '../model/problemDetailResponse';
// @ts-ignore
import { WelcomeSnapshot } from '../model/welcomeSnapshot';
...
export class ConfigExportImportAPIService {
    ...
    /**
     * Export a welcome page configuration
    ...
    public exportConfiguration(requestParameters: ExportConfigurationRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/images/export`;
        return this.httpClient.request<WelcomeSnapshot>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: exportWelcomeRequest,
    ...
    /**
     * Import welcome page configuration into a specific workspace by its name
     * @param requestParameters
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public importConfiguration(requestParameters: ImportConfigurationRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/images/${this.configuration.encodeParam({name: "workspaceName", value: workspaceName, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/import`;
        return this.httpClient.request<any>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: welcomeSnapshot,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
